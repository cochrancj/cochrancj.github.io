  ...
  $("#accentVegDie").click(function() {
    ...
    if ($("#accent-veg-output").children().length == 0) {
      var accentVegTypes = [
        ...
        '<div class="ingredient-image"><img src="images/Leafy-Greens-Outline.jpg" alt="This is a line drawing of leafy greens"></div><div class="option-expanded"><span class="green">Leafy Greens</span><p>Wash and chop into bite-sized pieces. Add during the last 5 - 10 minutes of cooking if your method is sautee, stir-fry or soup. Cook separately in a little fat over medium-high heat if your cooking method is braise, roast or slow-cook.</p></div>',
        ...
        '<div class="ingredient-image"><img src="images/Brussels-Sprouts-Outline.jpg" alt="This is a line drawing of brussels sprouts"></div><div class="option-expanded"><span class="green">Brussels Sprouts</span> <p>Slice in half lengthwise or shred into a slaw. Good to use with any cooking method.</p></div>'
      ];
