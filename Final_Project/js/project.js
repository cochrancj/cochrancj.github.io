  ...
  $("#accentVegDie").click(function() {
    ...
    if ($("#accent-veg-output").children().length == 0) {
      var accentVegTypes = [
        ...
        '<div class="ingredient-image"><img src="images/Leafy-Greens.png" alt="This is a line drawing of leafy greens"></div><div class="option-expanded"><span class="darkgreen">Leafy Greens</span><p>Wash and chop into bite-sized pieces. Add during the last 5 - 10 minutes of cooking if your method is sautee, stir-fry or soup. Cook separately in a little fat over medium-high heat if your cooking method is braise, roast or slow-cook.</p></div>',
  ...
  $("#cookTypeDie").click(function() {
    ...
    if ($("#cook-type-output").children().length == 0) {
      var cookTypeTypes = [
        ...
        '<div class="ingredient-image"><img src="images/Sautee.png" alt="This is a line drawing of a skillet"></div><div class="option-expanded"><span class="black">Sautee</span> <p>Grab your largest and heaviest frying pan. Set the heat to medium-high, and add a couple Tablespoons of a fat with a high smoke point (sesame oil is great for Asian style cooking&#059; grapeseed, coconut oil or avocado oil is a nice neutral base for other cooking types&#059; butter is always nice). When the pan is hot (a drop of water sputters when flicked into the pan), add your ingredients. Your dinner is done when your protein is cooked through and your veggies are softened and browned in spots.</p></div>',
