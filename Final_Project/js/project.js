...
// ===================================================================================
  ...
  $("#accentVegDie").click(function() {
    ...
    if ($("#accent-veg-output").children().length == 0) {
      var accentVegTypes = [
        '<div class="ingredient-image"><img src="images/Bell-Pepper-Outline.jpg" alt="This is a line drawing of a bell pepper"></div><div class="option-expanded"><span class="green">Bell Pepper</span><p>Slice your pepper in half. De-seed and chop. Good to use with any cooking method.</p></div>',
        '<div class="ingredient-image"><img src="images/Leafy-Greens-Outline.jpg" alt="This is a line drawing of leafy greens"></div><div class="option-expanded"><span class="darkgreen">Leafy Greens</span><p>Wash and chop into bite-sized pieces. Add during the last 5 - 10 minutes of cooking if your method is sautee, stir-fry or soup. Cook separately in a little fat over medium-high heat if your cooking method is braise, roast or slow-cook.</p></div>',
        '<div class="ingredient-image"><img src="images/Green-Bean-Outline.jpg" alt="This is a line drawing of green beans"></div><div class="option-expanded"><span class="green">Green Beans</span> <p>Wash and de-tip. Good to use with any cooking method.</p></div>',
        '<div class="ingredient-image"><img src="images/Broccoli-Outline.jpg" alt="This is a line drawing of broccoli"></div><div class="option-expanded"><span class="darkgreen">Broccoli</span> <p>Wash, cut the crowns into inch/inch and a half pieces. The stalks are also good to eat, just slice the outside off and cut into bite-sized pieces. Broccoli is good to throw into any of the cooking methods. </p></div>',
        '<div class="ingredient-image"><img src="images/Carrot-Outline.jpg" alt="This is a line drawing of carrots"></div><div class="option-expanded"><span class="orange">Carrots</span> <p>Slice into 1/4 inch thick coins or chop into bite-sized pieces. Good to use with any cooking method.</p></div>',
        '<div class="ingredient-image"><img src="images/Brussels-Sprouts-Outline.jpg" alt="This is a line drawing of brussels sprouts"></div><div class="option-expanded"><span class="lightgreen">Brussels Sprouts</span> <p>Slice in half lengthwise or shred into a slaw. Good to use with any cooking method.</p></div>'
      ];
